...
HTML_OUTPUT = "index.html"  # 📌 Ahora genera index.html en lugar de catalogo.html
...
def update_html():
    ...
    <head>
        ...
        <style>
            body { font-family: Arial, sans-serif; text-align: center; background-color: #f0f0f0; margin: 0; padding-bottom: 30px; }
            h1 { background: #0088cc; color: white; padding: 15px; margin: 0; }
            ...
            .producto { width: 100%; height: 280px; cursor: pointer; border-radius: 10px; overflow: hidden; transition: transform 0.3s ease; }
